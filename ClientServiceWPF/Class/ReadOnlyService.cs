...
namespace ClientServiceWPF.Class
{
    internal class ReadOnlyService : DependencyObject
    {
        ...
        /// </summary>
        private static readonly DependencyProperty BehaviorProperty = DependencyProperty.RegisterAttached("IsReadOnly", typeof(bool), typeof(ReadOnlyService), new FrameworkPropertyMetadata(false));
